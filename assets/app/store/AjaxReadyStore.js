...
Ext.define('App.store.AjaxReadyStore',{
     ...
     */
    createAndSync : function(data, success,error, allways) {
     ...
     * @param callback
     */
    destroyAndSync : function(id, callback,params,successCallback) {
        var me = this;

        console.log(me.proxy.api.destroy + '/' + id + me.getParams(params));
    ...
    promiseRead : function(){

        var me = this;

        this.fireEvent('beforeload',this);
        console.log('Promising {0} from {1}{2}'.format( Ext.getClassName(this), this.proxy.api.read) );
    ...
    readAndLoad : function(async, success, error, always, params, append) {
    ...
    stashFilters : function() {
        ...
        if(this.filters && this.filters.items.length > 0) {
    ...
    getParams : function(p) {
        ...
        return App.lib.Util.getParams(p);
    },
